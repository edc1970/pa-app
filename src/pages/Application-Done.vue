        ...
        <div class="medical">
          <div class="row">
            <div class="col-10 text-grey-9 q-pa-xl">
              ...
              <p class="quattro text-h6 text-grey-10">Your application for <b>Personal Accident Insurance</b> is now under process.  Details of your application and status of payment has been emailed to <span class="text-bold">{{ emailAddress }}</span>.</p>
